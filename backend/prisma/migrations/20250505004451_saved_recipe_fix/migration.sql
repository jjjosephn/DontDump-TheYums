/*
  ...
  - Added the required column `savedRecipeId` to the `SavedRecipe` table without a default value. This is not possible if the table is not empty.
...
ADD CONSTRAINT "SavedRecipe_pkey" PRIMARY KEY ("userId", "savedRecipeId");
